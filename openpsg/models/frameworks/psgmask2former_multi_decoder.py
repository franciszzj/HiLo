...
class PSGMask2FormerMultiDecoder(SingleStageDetector):
    def __init__(self,
                 backbone,
                 bbox_head,
                 train_cfg=None,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(PSGMask2FormerMultiDecoder, self).__init__(backbone, None, bbox_head, train_cfg,
    ...
    def forward_train(self,
        ...
        losses = self.bbox_head.forward_train(x, img_metas, gt_rels, high2low_gt_rels, low2high_gt_rels, gt_bboxes,
                                              gt_labels, gt_masks,
                                              gt_bboxes_ignore)
        return losses

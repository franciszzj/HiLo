...
train_pipeline = [
    ...
    dict(type='LoadPanopticSceneGraphAnnotations',
         ...
         with_mask=True,
         with_seg=True),
    dict(type='SaveIntermediateResults',
         save_json='/jmain02/home/J2AD019/exk01/zxz35-exk01/data/data/psg_clip/train.json',
         save_dir='/jmain02/home/J2AD019/exk01/zxz35-exk01/data/data/psg_clip/',
         save_type='bbox'),
...
test_pipeline = [
    ...
    dict(type='LoadPanopticSceneGraphAnnotations',
         ...
         with_seg=True),
    dict(type='SaveIntermediateResults',
         save_json='/jmain02/home/J2AD019/exk01/zxz35-exk01/data/data/psg_clip/test.json',
         save_dir='/jmain02/home/J2AD019/exk01/zxz35-exk01/data/data/psg_clip/',
         save_type='bbox',
         vis=True),
    dict(
